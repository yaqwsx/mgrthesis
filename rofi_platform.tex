\chapter{RoFI Platform}\label{chap:rofi}
...
There are two crucial observations to note:
\begin{enumerate*}
...
To allow algorithms to take various sensors present on modules into account, a
