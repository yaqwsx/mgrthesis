...
\begin{figure}[h!]
    ...
    follow figure \ref{fig:rofi_locks}. }
...
disadvantages:
\begin{itemize}
    \item it has a limited bandwidth of 1 Mb/s \todo{cite},
...
switch) or introduce a custom L1/L2 layer from the OSI/ISO model. Introduction
of custom L1/L2 layers is quite common (see \cite{waitzman_ip_1999}).
