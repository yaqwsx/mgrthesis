...
interface, which can be possibly mass produced and reused in all the modules.

\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/dock_overview.pdf}
    \caption{\todo{dock overview}}
...
\begin{figure}
    ...
    \caption{\todo{dock key components}}
...
\begin{figure}
    ...
    \caption{\todo{dock internal arrangement}}
